        ...
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('admin.dashboard') }}" class="b-brand">
                    <img src="{{ asset('logo.png') }}" alt="" class="logo logo-lg" style="width:50px;height: 50px;" />
                    <span style="font-size: 28px; font-weight: bold;" class="logo logo-lg">ReproServe</span>
                    <img src="{{ asset('logo.png') }}" alt="" class="logo logo-sm" style="width:50px;height: 50px;" />
                </a>
            </div>
