 <div class="main-nav">
             ...
             <div class="logo-box">
                  ...
                  <a href="{{ route('admin.dashboard') }}" class="logo-light flex h-16 items-center justify-between">
                       <img src="{{ asset('logo.png') }}" class="logo-sm" alt="logo sm">
                       <img src="{{ asset('logo.png') }}" class="logo-lg" alt="logo light">
                       <span class="font-bold text-xl text-white drop-shadow-lg">ReproServe</span>
                  </a>
             </div>
